export const PROVIDERS = {
  ...
  bailian: {
    ...
    mainModels: [
      ...
      ['qwen-plus-latest', 'Qwen Plus Latest', '通义千问'],
      ['qwen-max-latest', 'Qwen Max Latest', '通义千问'],
      ['qwen-flash', 'Qwen Flash', '通义千问'],
      ...
      ['MiniMax-M2.7', 'MiniMax M2.7', '百炼第三方'],
      ['mimo-v2.5-pro', 'MiMo V2.5 Pro', '百炼第三方'],
    ],
    imageModels: [
      ['wan2.7-image-pro', 'Wan 2.7 Image Pro', '通义万相'],
      ['wan2.7-image', 'Wan 2.7 Image', '通义万相'],
      ['wan2.6-image', 'Wan 2.6 Image', '通义万相'],
      ['wan2.6-t2i', 'Wan 2.6 T2I', '通义万相'],
      ['wan2.5-t2i-preview', 'Wan 2.5 T2I Preview', '通义万相'],
      ['wan2.2-t2i-plus', 'Wan 2.2 T2I Plus', '通义万相'],
      ['wan2.2-t2i-flash', 'Wan 2.2 T2I Flash', '通义万相'],
      ['qwen-image-2.0-pro', 'Qwen Image 2.0 Pro', '通义千问 Image'],
      ['qwen-image-2.0', 'Qwen Image 2.0', '通义千问 Image'],
      ['qwen-image-max', 'Qwen Image Max', '通义千问 Image'],
      ['qwen-image-plus', 'Qwen Image Plus', '通义千问 Image'],
